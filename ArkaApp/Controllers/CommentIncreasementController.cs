...
namespace ArkaApp.Controllers
{
    ...
    public class CommentIncreasementController : Controller
    {
        ...
        [HttpPost]
        public ActionResult Increase(Models.EntityModels.CommentLog model)
        {
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    HttpResponseMessage res = api.IncreaseComment(post);
                    ...
                    {
                        //Save Log
                        CommentLogHelper log = new CommentLogHelper();
                        ...
                        var logId = log.SaveLog(model.PostID, (long)model.Count, (short)model.Gender, (short)model.Priority);

                        Utility.SaveWalletPaymentLog((long)model.Count, logId, Models.ActionEnumModel.Comment, options);
                    ...
                    apiLog.SaveLog(Utility.GetAccountId(), model.PostID, Models.ActionEnumModel.Comment + " - " + result.Desc, result.State);
