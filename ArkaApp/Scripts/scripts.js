...
$(function () {
    ...
    $(".choose-theme li").on("click", function () {
        ...
        localStorage.setItem('theme-color', $(this).attr("title"));
    });
    ...
    $(".sidebar-color input:radio").change(function () {
        if ($(this).val() == "1") {
            ...
            localStorage.setItem('side-color', 'light');

        } else {
            $("body").removeClass("light-sidebar");
            $("body").addClass("dark-sidebar");
            localStorage.setItem('side-color', 'dark');
        }
    });
    ...
    $(".btn-restore-theme").on("click", function () {
        ...
        jQuery("body").addClass("theme-insta");

        // set default theme
        $(".choose-theme li").removeClass("active");
        $(".choose-theme li[title|='insta']").addClass("active");
        ...
        localStorage.setItem('theme-color', 'insta');
        localStorage.setItem('theme-layout', 'light');
        localStorage.setItem('side-color', 'light');
        localStorage.setItem('mini', 'false');
        localStorage.setItem('sticky', 'true');
    ...
    var layout = localStorage.getItem('theme-layout');
    var side = localStorage.getItem('side-color');
    ...
    if (color != null) {
        jQuery("body").addClass("theme-" + color);
    }
    else {
        jQuery("body").addClass("theme-insta");
        localStorage.setItem('theme-color', 'insta');
    ...
    $(".choose-theme li").removeClass("active");
    $(".choose-theme li[title|='" + color + "']").addClass("active");
    ...
    if (side != null) {
        jQuery("body").addClass(side + "-sidebar");
